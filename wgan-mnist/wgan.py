...
class Critic(chainer.Chain):
    """wgan-mnist for the mnist dataset"""
    ...
    def clip(self, lower=-0.01, upper=0.01):
...
class WGANUpdater(training.StandardUpdater):
    def __init__(self, iterator, noise_iterator, optimizer_generator,
                 optimizer_critic, device=-1, *args, **kwargs):
        ...
        self.iteration = 0
        super(WGANUpdater, self).__init__(iterators, optimizers, device=device, *args, **kwargs)
